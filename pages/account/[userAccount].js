                ...
                {view.agreeDeletion && (
                    <div className={styles.agreeDeletionWrapper}>
                        <div className={styles.agree}>
                            <div>
                                When You delete account, all personal and order information will lost forever. Agreed
                                this, You confirm deletion of your account.
                            </div>
                            <div>
                                <button
                                    onClick={() =>
                            ...
                            {view.confirmPassword && (
                                <div className={styles.confirm}>
                                    ...
                                    />
                                    <div>
                                        <button onClick={() => deleteAccount()} className={styles.btns}>
                                            Confirm
                                        </button>
                                        <button
                                            onClick={() =>
                        ...
                        <div className={styles.userPhoneWrapper}>
                            {view.phoneChanging ? (
                                <>
                                    ...
                                    />
                                    <div onClick={() => updateInfo(phone)} className={styles.changeBtn}>
                                        <RiCheckFill />
                                    </div>
                                    <div
                                        onClick={() =>
                                ...
                                <div className={styles.createAddressWrapper}>
                                    <div className={styles.descriptionWrapper}>
                                        ...
                                        <div hidden={descriptionHide} className={styles.description}>
                                            That information need for autocomplete your shipping address, when you
                                            buying somthing. It`s saves Your time, and do orders more easy and fast to
                                            fill.
                                        </div>
                                    </div>
                                    <button
